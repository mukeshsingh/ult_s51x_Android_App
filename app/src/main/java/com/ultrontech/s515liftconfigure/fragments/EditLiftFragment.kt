 ...
 * Use the [EditLiftFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditLiftFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EditLiftFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EditLiftFragment().apply {
