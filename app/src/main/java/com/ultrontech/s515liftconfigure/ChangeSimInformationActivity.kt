...
//                Toast.makeText(applicationContext, progress.toString(), Toast.LENGTH_LONG).show()
        ...
        binding.optionMenu.llMenuAccount.setOnClickListener {
            ...
            val intent = Intent(this@ChangeSimInformationActivity, UserProfileActivity::class.java)
            startActivity(intent)
        }
        binding.optionMenu.llMenuLanguage.setOnClickListener {
            binding.optionMenu.llOptionMenu.visibility = View.GONE
            val intent = Intent(this@ChangeSimInformationActivity, LanguageSelectorActivity::class.java)
            startActivity(intent)
        }
        binding.optionMenu.llMenuTroubleshoot.setOnClickListener {
            binding.optionMenu.llOptionMenu.visibility = View.GONE
            val intent = Intent(this@ChangeSimInformationActivity, TroubleshootingActivity::class.java)
            startActivity(intent)
        ...
        binding.optionMenu.llLogout.setOnClickListener {
            ...
            with(S515LiftConfigureApp) {
                profileStore.logout()
                val intent = Intent(this@ChangeSimInformationActivity, SplashActivity::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                startActivity(intent)
            }
        }
